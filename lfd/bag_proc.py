...
def correct_bag_errors(all_times):
    ...
    print 'After ignoring extra open/close events:', actions_to_str(all_times)
    ...
    all_times = corrected_all_times; corrected_all_times = []
    print 'After ignoring extra done events:', actions_to_str(all_times)
    ...
    return start_times, stop_times, look_times, l_close_times, l_open_times, r_close_times, r_open_times, done_times
